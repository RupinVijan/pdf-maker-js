...
export default function App() {
  function xyz(textxyz,textxyz1,textxyz2){
    let startX = 30;
    let startY = 30;
      ...
      textMap.map((text, i) => {
          if (text) {
              ...
              arrayOfNormalAndBoldText.map((textItems, j) => {
                  ...
                  startX = startX + doc.getStringUnitWidth(textItems) * 16;
              });
